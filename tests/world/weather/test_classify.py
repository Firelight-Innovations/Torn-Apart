"""
tests/world/weather/test_classify.py — Mirror for fire_engine/world/weather/classify.py.

Relocated from tests/test_weather_classify.py (verbatim).
Golden-master / characterisation tests for classify() and WeatherType.
