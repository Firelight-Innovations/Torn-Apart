"""
tests/test_wind_region.py — Golden-master / characterisation tests for
fire_engine.wind.region.WindRegion.
...
def _region(cells=64, cell_m=4.0, snap_cells=8, margin_cells=8) -> WindRegion:
    return WindRegion(cells=cells, cell_m=cell_m,
                      snap_cells=snap_cells, margin_cells=margin_cells)
...
class TestSnapGranularity:
    ...
    def test_snap_formula_positive_player(self):
        ...
        r = _placed(player_xy=(px, 0.0), cells=cells, cell_m=cell_m,
...
class TestDeterminism:
    ...
    def test_same_player_path_same_origin_sequence(self):
        path = [(0.0, 0.0), (50.0, 0.0), (200.0, 100.0), (-64.0, -64.0),
                (1000.0, -500.0)]
        seq_a, seq_b = [], []
