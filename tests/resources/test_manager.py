"""
tests/resources/test_manager.py — Headless and window-marked tests for the Resource Manager.
...
``pytest.ini``.  Run explicitly with::
    ...
    .venv/Scripts/python.exe -m pytest tests/resources/test_manager.py -m window -q
"""
...
def test_load_triangle_egg_with_panda3d():
    ...
    pytest.ini and must be explicitly invoked::
        ...
        pytest tests/resources/test_manager.py -m window -q
