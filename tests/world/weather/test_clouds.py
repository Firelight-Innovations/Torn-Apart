"""
tests/world/weather/test_clouds.py — Mirror for fire_engine/world/weather/clouds.py.

Relocated from tests/test_weather_clouds.py (verbatim).
WMO cloud genera classification + layers (M9).
...
def test_no_panda3d_import_in_weather_clouds():
    src = (
        Path(__file__).resolve().parents[3] / "fire_engine" / "world" / "weather" / "clouds.py"
