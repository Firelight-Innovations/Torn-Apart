...
class ScrubBushDef(TreeSpeciesDef):
    ...
    BARK_PALETTE = np.array([(46, 38, 26), (64, 53, 36), (82, 68, 47)],
                            dtype=np.uint8)
    # Dry olive, halfway to the dead ramp — wasteland scrub, not garden box.
    LEAF_PALETTE = np.array([(40, 46, 28), (56, 62, 36), (74, 78, 46),
                             (94, 96, 56)], dtype=np.uint8)
    ...
    def grow(self, rng: np.random.Generator,
        ...
        stems = sb.branches(stub, count=(4, 7), t_range=(0.6, 1.0),
                            ...
                            radius_ratio=0.7, min_radius_m=0.015,
                            upturn_rad=_D(20),
