...
per-frame orchestration of the headless :class:`~fire_engine.wind.WindField`
...
2 bytes × 4 channels), and :func:`~fire_engine.wind.pack_wind_field` produces
...
from fire_engine.wind import pack_wind_field
...
class WindSystemComponent(Component):
    ...
    worker : object | None
        The venturi worker (``fire_engine.wind.VenturiWorker``), or ``None``
