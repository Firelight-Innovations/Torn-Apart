"""
tests/world/weather/test_synoptic.py — Mirror for fire_engine/world/weather/synoptic.py.

Relocated from tests/test_weather_synoptic.py (verbatim).
Synoptic flow (fire_engine/world/weather/synoptic.py).
