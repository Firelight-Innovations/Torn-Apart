...
This module bridges ``torn_apart.resources`` (panda3d-free) with the real
...
callables into ``torn_apart.resources.loaders`` via
...
-----
    ...
    from torn_apart.resources import load, acquire
...
def register_panda_loaders(resource_manager: "ResourceManager") -> None:
    ...
    resource_manager : ResourceManager
        ...
        ``torn_apart.resources.default_manager`` for the production singleton.
