...
class BerryBushDef(TreeSpeciesDef):
    ...
    BARK_PALETTE = np.array([(42, 34, 24), (58, 48, 33), (74, 62, 43)],
                            dtype=np.uint8)
    # The one genuinely alive ramp in the wasteland palette.
    LEAF_PALETTE = np.array([(28, 48, 26), (40, 66, 34), (54, 84, 42),
                             (72, 102, 52), (92, 118, 62)], dtype=np.uint8)
