"""
tests/world/weather/test_system.py — Mirror for fire_engine/world/weather/system.py.

Relocated from tests/test_weather_system.py (verbatim).
Spatial WeatherSystem: sampling, classify, override shim, Saveable.
...
from fire_engine.world.weather.system import BLEND_SECONDS, HYSTERESIS_SECONDS
