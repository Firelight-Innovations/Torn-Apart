...
- Filenames mirror the full package path (dots for nesting): `docs/systems/world.terrain.md` documents `fire_engine/world/terrain/`; `docs/systems/render.md` documents `fire_engine/render/`.
