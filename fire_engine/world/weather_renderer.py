...
It owns the headless :class:`~fire_engine.weather.WeatherMap` (``weather/`` is
...
:func:`~fire_engine.sky.pack_weather_map`, and binds the **weather-map uniform
...
Driver coordination
--------------------
The :class:`~fire_engine.world.sky_renderer.SkyRendererComponent` is the single
...
``wind_renderer.py`` pioneered; :func:`~fire_engine.sky.pack_weather_map`
...
from fire_engine.sky import pack_weather_map
from fire_engine.weather import WeatherMap
...
class WeatherMapComponent(Component):
    ...
    sky_system : fire_engine.sky.SkySystem
        ...
        :class:`~fire_engine.weather.WeatherSystem`) is rasterised here; its
