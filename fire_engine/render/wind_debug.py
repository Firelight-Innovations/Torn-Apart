...
:meth:`~fire_engine.world.wind.WindField.sample` the future physics/audio systems will
...
- The physics is the panda3d-free pure function
  :func:`fire_engine.world.wind.debug_ball_step` (headless-tested); this component is
...
class WindBallDebugComponent(Component):
    ...
    sky_system : fire_engine.world.sky.SkySystem | None
