...
for _ in range(200): app.taskMgr.step(); app._clock.game_time_of_day=hold
...
for casc in pipe.cascades:
    geom=rb(casc.geom); vis=rb(casc.vis)
    ...
    def kz(zw): return int((zw-om[2])/cm)
