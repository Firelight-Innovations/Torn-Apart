...
::
    ...
    from torn_apart.procedural.registry import register, get, clear_cache
...
def _current_world_seed() -> int:
    ...
    from torn_apart.core import rng as _rng  # noqa: PLC0415
...
def get(name: str, **params) -> Any:
    ...
    **params : any JSON-serialisable value
    ...
    from torn_apart.core.rng import for_domain  # noqa: PLC0415
...
def clear_cache() -> None:
    ...
    ::
        ...
        from torn_apart.procedural.registry import clear_cache, get
...
def reset_registry() -> None:
    ...
    ::
        ...
        from torn_apart.procedural.registry import reset_registry, register, get
        reset_registry()
