...
:class:`~torn_apart.devtools.fields.Section`s the Inspector shows: identity,
...
from torn_apart.devtools.fields import Field, FieldKind, Section
...
def is_chunk(obj: Any) -> bool:
    """
    True when ``obj`` is a terrain :class:`~torn_apart.terrain.chunk.Chunk`.
