"""
fire_engine.world.wind — Spatially-varying, time-evolving wind field (headless).
...
from fire_engine.world.wind.debug import BallParams, debug_ball_step
from fire_engine.world.wind.field import (
    WindField,
    WindSnapshot,
    pack_wind_field,
    vertical_profile,
