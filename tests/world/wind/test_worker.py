"""
tests/world/wind/test_worker.py — Characterisation / golden-master tests for
...
# ─────────────────────────────────────────────────────────────────────────────
# Shared constants / helpers (mirror test_venturi.py without duplicating)
# ─────────────────────────────────────────────────────────────────────────────
VOXEL = 0.5
CHUNK = 32
...
def _solid_job(cfg: Config, *, seq: int = 1, cells: int = 8) -> VenturiJob:
    ...
    wall-with-gap scenario in test_venturi.py.  Produces speedup ≈ 1
...
# ─────────────────────────────────────────────────────────────────────────────
# On-thread equivalence (different job from test_venturi.py)
# ─────────────────────────────────────────────────────────────────────────────
...
class TestOnThreadEquivalence:
    def test_fully_solid_job_matches_inline(self):
        ...
        test_venturi.py::TestVenturiWorker::test_worker_matches_on_thread.
        """
        cfg = _cfg()
