...
from fire_engine.world.grass_renderer import (
    _GUST_FREQ_MIN,
    _GUST_FREQ_PER_WIND,
    _GUST_FREQ_RAIN,
    _SWAY_BASE_MIN_M,
...
class TreeRendererComponent(Component):
    ...
    def _build_volume(self, kind: _TreeKind, vol) -> None:
        ...
        from fire_engine.world.texture_bridge import to_data_texture_f32
    ...
    def _mesh_geom(self, name: str, variant: int, vs) -> Geom:
        ...
        if geom is None:
            from fire_engine.world.geometry_bridge import to_geom
