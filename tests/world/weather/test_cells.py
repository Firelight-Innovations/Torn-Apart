"""
tests/world/weather/test_cells.py — Mirror for fire_engine/world/weather/cells.py.

Relocated from tests/test_weather_cells.py (verbatim).
Storm cells and the natural spawn schedule.
...
# ---------------------------------------------------------------------------
# Tests for StormCell.contribution()
# ---------------------------------------------------------------------------
...
class TestNoPanda3D:
    def test_no_panda3d_import_in_weather_package(self):
        ...
        weather_dir = (
            Path(__file__).parent.parent.parent.parent / "fire_engine" / "world" / "weather"
        )
        offenders = []
