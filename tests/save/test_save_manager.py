"""
tests/save/test_save_manager.py — SaveManager round-trip, compatibility checks,
size bounds, no-pickle enforcement, and numpy/tuple-key encoding.  Headless: no panda3d.

Mirror of fire_engine/save/save_manager.py.
Relocated from tests/test_save.py.
"""
