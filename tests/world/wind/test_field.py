"""
tests/world/wind/test_field.py — Headless tests for fire_engine/world/wind/field.py (WP1).
...
class TestNoPanda3D:
    def test_no_panda3d_import_in_wind_package(self):
        ...
        wind_dir = Path(__file__).parent.parent.parent.parent / "fire_engine" / "world" / "wind"
        offenders = []
