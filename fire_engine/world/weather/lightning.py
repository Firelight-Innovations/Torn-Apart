...
A THUNDERSTORM :class:`~fire_engine.world.weather.StormCell` fires strikes on a
...
-------
    ...
    from fire_engine.world.weather.cells import natural_cells, CellKind
    from fire_engine.world.weather.lightning import scheduled_strikes
