...
from fire_engine.world.camera import CameraComponent
...
class App(ShowBase):
    ...
    def _push_input_to_controllers(self) -> None:
        ...
        from fire_engine.world.registry import _STATE
    ...
    def _stream_and_upload_terrain(self) -> None:
        ...
        from fire_engine.world.geometry_bridge import to_geom_node
