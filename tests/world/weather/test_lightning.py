"""
tests/world/weather/test_lightning.py — Mirror for fire_engine/world/weather/lightning.py.

Relocated from tests/test_weather_lightning.py (verbatim).
Procedural lightning (M7): bolt geometry + strike schedule.
...
def test_no_panda3d_in_weather_lightning():
    ...
    root = Path(__file__).resolve().parents[3] / "fire_engine" / "world" / "weather"
