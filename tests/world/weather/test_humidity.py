"""
tests/world/weather/test_humidity.py — Mirror for fire_engine/world/weather/humidity.py.

Relocated from tests/test_weather_humidity_edges.py (verbatim).
Characterisation / golden-master tests for the pure humidity functions.
...
No panda3d imports; all assertions use numpy so that vectorisation is fully exercised.
"""
